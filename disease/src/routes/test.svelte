...
<div class="arena">
            ...
            {#each playerHand as playerHandCard}
                <div on:dblclick={playerPlay(playerHandCard)}>
                    <Card
                        ...
                        isCovered={playerHandCard.isCovered}
                    />
                </div>
            {/each}
        </div>
    ...
    <div class="board">
        ...
        <div class="hud">
            <button class="check-enemy" on:click={playerCheck} class:turn={playerTurn}
                >defensorChek</button
            >
            <p class="life">{life}</p>
            <button class="check-player" on:click={enemyCheck} class:turn={enemyTurn}
                >invasorCheck</button
            >
        </div>
